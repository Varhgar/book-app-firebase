...
This is a simple book management application that allows users to add, edit, and remove books from a personal library. The application is built with React and Vite, and it uses local storage to persist the book data.

## Features

*   **Book List:** Displays a grid of books with their cover image, title, author, and genre.
